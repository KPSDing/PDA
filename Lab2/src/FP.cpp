...
std::default_random_engine rng(std::random_device{}());  // 初始化隨機數生成器
...
//     root = insert(root, index, length);
// }

// void BST::deleteNodeBST(int p, int t) {
//     root = deleteNode(root, p, t);
// }

// Node* BST::createNode(int index, int length) {
...
// Node* BST::insert(Node* insertroot, int index, int length) {
//     if (insertroot == nullptr) {
//         return createNode(index, length);
//     }

//     if (index < insertroot->index) {
//         insertroot->left = insert(insertroot->left, index, length);
//     } else if (index > insertroot->index) {
//         insertroot->right = insert(insertroot->right, index, length);
//     }

//     return insertroot;
// }

// // 找到小於 p 的最大 index，並返回對應的 length
...
// // 刪除 index 大於 p 且 length 小於 t 的節點
// // Node* BST::deleteNode(Node* deleteroot, int p, int t) {
// //     if (deleteroot == nullptr) {
// //         return deleteroot;
// //     }
// //     deleteroot->left = deleteNode(deleteroot->left, p, t);
// //     deleteroot->right = deleteNode(deleteroot->right, p, t);

// //     if (deleteroot->index > p && deleteroot->length < t) {
// //         deleteroot = deletetheNode(deleteroot, deleteroot->index);
// //     }
// //     return deleteroot;
// // }
// Node* BST::deleteNode(Node* deleteroot, int p, int t) {
...
//     if (deleteroot->index > p && deleteroot->length < t) {
//         Node* temp = deletetheNode(deleteroot, deleteroot->index);
//         deleteroot = temp;
//     }
//     return deleteroot;
// }
...
// // 刪除元素
// // Node* BST::deletetheNode(Node* deleteroot, int index) {
// //     if (deleteroot == nullptr) {
// //         return deleteroot;
// //     }

// //     if (index < deleteroot->index) {
// //         deleteroot->left = deletetheNode(deleteroot->left, index);
// //     } else if (index > deleteroot->index) {
// //         deleteroot->right = deletetheNode(deleteroot->right, index);
// //     } else {
// //         // 節點只有一個子節點或沒有子節點
// //         if (deleteroot->left == nullptr) {
// //             Node* temp = deleteroot->right;
// //             delete deleteroot;
// //             return temp;
// //         } else if (deleteroot->right == nullptr) {
// //             Node* temp = deleteroot->left;
// //             delete deleteroot;
// //             return temp;
// //         }

// //         // 節點有兩個子節點
// //         Node* temp = findMin(deleteroot->right);
// //         deleteroot->index = temp->index;
// //         deleteroot->length = temp->length;
// //         deleteroot->right = deletetheNode(deleteroot->right, temp->index);
// //     }
...
// // 查找最小值節點
// Node* BST::findMin(Node* findroot) {
//     while (findroot->left != nullptr) {
